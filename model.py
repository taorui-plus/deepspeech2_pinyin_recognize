...
from keras.layers import (BatchNormalization, Convolution1D, Dense, LSTM, Bidirectional,
...
def compile_train_fn(model, learning_rate=5e-5):
    ...
    updates = lasagne.updates.adam(grads, trainable_vars, 
                                   learning_rate, beta1=0.9, beta2=0.99)
...
def compile_gru_model(input_dim=101, output_dim=409, recur_layers=3, nodes=1024,
